...
Partial Public Class Database1DataSet
    ...
    Partial Public Class Table1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddTable1Row(ByVal roll_no As Integer, ByVal name As String, ByVal branch As String) As Table1Row
            Dim rowTable1Row As Table1Row = CType(Me.NewRow,Table1Row)
            Dim columnValuesArray() As Object = New Object() {roll_no, name, branch}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindByroll_no(ByVal roll_no As Integer) As Table1Row
            Return CType(Me.Rows.Find(New Object() {roll_no}),Table1Row)
        End Function
    ...
    Partial Public Class Table1Row
        ...
        Public Function IsbranchNull() As Boolean
            Return Me.IsNull(Me.tableTable1.branchColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetbranchNull()
            Me(Me.tableTable1.branchColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace Database1DataSetTableAdapters
    ...
    Partial Public Class Table1TableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`roll no` = ?) AND ((? = 1 AND `branch` IS NULL) OR "& _ 
                "(`branch` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`roll no`, `name`, `branch`) VALUES (?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `roll no` = ?, `name` = ?, `branch` = ? WHERE ((`roll no` = ?"& _ 
                ") AND ((? = 1 AND `branch` IS NULL) OR (`branch` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.testdata2.vb.My.MySettings.Default.Database1ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT [roll no], name, branch FROM Table1"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_roll_no As Integer, ByVal Original_branch As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal roll_no As Integer, ByVal name As String, ByVal branch As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal roll_no As Integer, ByVal name As String, ByVal branch As String, ByVal Original_roll_no As Integer, ByVal Original_branch As String) As Integer
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(3).Value = CType(Original_roll_no,Integer)
            If (Original_branch Is Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(1,Object)
                Me.Adapter.UpdateCommand.Parameters(5).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Original_branch,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal name As String, ByVal branch As String, ByVal Original_roll_no As Integer, ByVal Original_branch As String) As Integer
            Return Me.Update(Original_roll_no, name, branch, Original_roll_no, Original_branch)
        End Function
    End Class
